...
import type { JohnManuscriptData, IllustrationNote, ReferenceNote } from '@/lib/project/johnManuscriptData'
import { setStorageItem } from '@/lib/storage'
import { getVersions, saveVersion, restoreVersion, type ManuscriptVersion } from '@/lib/project/versionManager'
