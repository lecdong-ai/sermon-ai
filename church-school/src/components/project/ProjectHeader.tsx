...
import { ProjectDetail, PROJECT_STATUS_ORDER } from '@/lib/project/types'
...
import { ProjectStatusBadge } from '@/components/project/shared'
import { MOCK_SAVE_STATE } from '@/lib/project/statusData'
    ...
    <div className="bg-[#04060f]/60 border-b border-white/5 shrink-0">
      <div className="max-w-[1440px] mx-auto px-6 py-4">
        ...
        <div className="flex items-center gap-1 text-[11px] text-slate-500 mb-2">
          ...
          <button onClick={() => router.push('/projects')} className="hover:text-indigo-400 transition-colors">프로젝트</button>
          <span className="text-slate-600">/</span>
