    ...
    <div className="flex flex-col min-h-0 flex-1 h-full bg-[#050814] text-slate-100">
      ...
      <header className="flex items-center justify-between px-6 py-3 border-b border-white/10 bg-[#0a0f24]/90 backdrop-blur-md shrink-0 shadow-lg z-10 w-full gap-4">
        ...
        <div className="flex items-center gap-2.5 justify-center flex-1 relative">
          ...
          {/* ★ ===== [미니 달력 팝업 드롭다운 모달: 방금 좋아하셨던 선명한 High-Contrast 럭셔리 디자인 100% 복원] ===== */}
          {isDatePickerOpen && (
            <div className="absolute top-16 mt-2 left-1/2 -translate-x-1/2 z-50 bg-slate-950 border-2 border-indigo-400/70 rounded-2xl shadow-[0_24px_80px_rgba(0,0,0,0.95)] p-4.5 w-[360px] backdrop-blur-2xl animate-in zoom-in-95 duration-150 text-left ring-1 ring-white/20">
