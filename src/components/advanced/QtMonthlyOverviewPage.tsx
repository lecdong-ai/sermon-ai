    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-slate-300 pb-2 mb-2">
        ...
        <div className="flex items-center space-x-3 text-[11px] font-medium text-slate-400 font-mono">
          ...
          <span data-nav-target="overview" className="px-2 py-0.5 rounded bg-slate-800 text-white font-bold cursor-pointer shadow-2xs">
            {isGeneralMode ? '🌿 5-WEEK STRATEGY OVERVIEW' : '📊 5-WEEK OVERVIEW'}
          </span>
