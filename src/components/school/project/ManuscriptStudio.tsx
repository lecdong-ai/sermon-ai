...
import type { JohnManuscriptData, IllustrationNote, ReferenceNote } from '@/lib/school/project/johnManuscriptData'
import { setStorageItem } from '@/lib/school/storage'
import { getVersions, saveVersion, restoreVersion, type ManuscriptVersion } from '@/lib/school/project/versionManager'
