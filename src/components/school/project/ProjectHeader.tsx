...
import { ProjectDetail, PROJECT_STATUS_ORDER } from '@/lib/school/project/types'
...
import { ProjectStatusBadge } from '@/components/school/project/shared'
import { MOCK_SAVE_STATE } from '@/lib/school/project/statusData'
    ...
    <div className="bg-[#04060f]/60 border-b border-white/5 shrink-0">
      <div className="max-w-[1440px] mx-auto px-6 py-4">
        ...
        <div className="flex items-center gap-1 text-[11px] text-slate-500 mb-2">
          <button onClick={() => router.push('/school/advanced')} className="hover:text-indigo-400 transition-colors">대시보드</button>
          <span className="text-slate-600">/</span>
          <button onClick={() => router.push('/school/projects')} className="hover:text-indigo-400 transition-colors">프로젝트</button>
          <span className="text-slate-600">/</span>
