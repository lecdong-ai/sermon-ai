        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><Link href="/school/notice-writer" className="text-sm text-navy-300 hover:text-mint-400 transition-colors">공지문 작성기</Link></li>
              <li><Link href="/school/pricing" className="text-sm text-navy-300 hover:text-mint-400 transition-colors">요금제</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><Link href="/school/mypage" className="text-sm text-navy-300 hover:text-mint-400 transition-colors">마이페이지</Link></li>
