...
import type { SermonRecord } from '@/types/school/workspace'
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-5 pt-3 pb-2">
            <div className="flex items-center justify-between mb-2">
              <span className="text-[13px] font-bold text-[#2c2a29]">생성 진행률</span>
              <span className="text-[12px] font-medium text-[#8a8580]">{doneCount}/{totalCount}</span>
            </div>
            <div className="h-1.5 rounded-full bg-[#e4e2dd] overflow-hidden">
              <div
                className="h-full rounded-full bg-[#8d7a5b] transition-all duration-500 ease-out"
