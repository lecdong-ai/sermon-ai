...
export type PreviewTabType =
  ...
  | 'prayer' | 'prayer2' | 'scripture' | 'scripture2' | 'sermon' | 'sermondeep' | 'biblemap' | 'letter'
        ...
        <div className="col-span-12 lg:col-span-4 space-y-4">
          ...
          <div className="p-4 rounded-2xl bg-slate-900/70 border border-white/10 space-y-2.5 backdrop-blur-md shadow-2xl">
            ...
            <div className="grid grid-cols-2 gap-1.5 text-xs">
              ...
              >
                ...
                <span className="text-[9.5px] font-normal text-slate-400">기본4종 + 크리스천12종</span>
              </button>
              ...
              >
                <div className="flex items-center justify-between">
                  <span>✨ 전체 수집 팩</span>
                  <span className="text-[9px] opacity-70">31종</span>
                </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-900/70 border border-white/10 space-y-3 backdrop-blur-md shadow-2xl">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] text-slate-400 font-mono">31 Formats</span>
            </div>
