...
function NewSermonForm() {
  ...
  const [appSuggestions, setAppSuggestions] = useState<{ value: string; reason: string }[]>([])
        ...
        <div className="bg-surface border border-border rounded-lg p-6 space-y-5">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-sm font-semibold text-foreground">AI 추천 영역</h3>
            </div>
            ...
            <textarea
              ...
              rows={5}
              placeholder="설교 제목, 성경 본문, 핵심 메시지, 3대지를 바탕으로 그리스도 중심의 적용을 AI 추천받아보세요."
              className="w-full px-3 py-2 text-sm border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-primary-light resize-none"
            />
              ...
              <div className="mt-1.5 border border-border rounded-md bg-surface divide-y divide-border">
                ...
                {appSuggestions.map((s, i) => (
                  <button
                    ...
                    type="button"
                    onClick={() => {
                      updateField('christApplication', s.value)
                      setAppSuggestions([])
                    }}
                    className="w-full text-left px-2.5 py-2 text-xs hover:bg-slate-50 transition-colors"
                  >
            ...
            <textarea
              ...
              rows={4}
              placeholder="AI 추천을 통해 서론을 작성해보세요."
              className="w-full px-3 py-2 text-sm border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-primary-light resize-none"
            />
            ...
            <textarea
              ...
              rows={4}
              placeholder="AI 추천을 통해 예화를 작성해보세요."
              className="w-full px-3 py-2 text-sm border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-primary-light resize-none"
            />
            ...
            <textarea
              ...
              rows={4}
              placeholder="AI 추천을 통해 결론을 작성해보세요."
              className="w-full px-3 py-2 text-sm border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-primary-light resize-none"
            />
