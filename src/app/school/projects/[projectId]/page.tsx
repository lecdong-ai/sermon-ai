...
import { useProjectDetail } from '@/lib/school/project/useProjectDetail'
...
import ProjectHeader from '@/components/school/project/ProjectHeader'
import RightPanel from '@/components/school/project/RightPanel'
import OverviewTab from '@/components/school/project/OverviewTab'
import BibleStudyTab from '@/components/school/project/BibleStudyTab'
import PrepTab from '@/components/school/project/PrepTab'
import ManuscriptTab from '@/components/school/project/ManuscriptTab'
import ConnectionsTab from '@/components/school/project/ConnectionsTab'
import VersionsTab from '@/components/school/project/VersionsTab'
import LinkedInsightBanner from '@/components/school/project/LinkedInsightBanner'
...
function ProjectContent() {
  ...
  useEffect(() => {
    ...
    if (detectedIdx > currentIdx) {
      ...
      fetch(`/school/api/sermons/${params.projectId}`, {
        method: 'PUT',
    ...
    return (
      <div className="flex items-center justify-center h-full min-h-[calc(100vh-4rem)]" style={{ background: 'linear-gradient(180deg, #050816 0%, #0a0e1a 50%, #0d1220 100%)' }}>
        <div className="text-center max-w-sm space-y-4">
          ...
          <button
            onClick={() => router.push('/school/projects')}
