...
export default function CheckInPage() {
  ...
  useEffect(() => {
    ...
    fetch('/school/api/events/checkin', {
      method: 'POST',
      ...
      <div className="max-w-sm w-full">
        ...
        {status === 'unauthorized' && (
          <div className="text-center bg-white rounded-2xl border border-warm-200 p-8">
            ...
            <Link href="/school/" className="inline-flex px-6 py-3 bg-navy-900 text-white font-semibold rounded-xl hover:bg-navy-800 transition-colors">
              로그인하러 가기
            </Link>
          </div>
        )}
