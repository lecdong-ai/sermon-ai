...
import { invalidateCache } from '@/lib/school/templateRegistry'
...
export default function AdminTemplatesPage() {
  ...
  const loadTemplates = useCallback(async () => {
    try {
      const res = await fetch('/school/api/admin/templates')
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      const res = await fetch(`/school/api/admin/templates/${id}`, { method: 'DELETE' })
