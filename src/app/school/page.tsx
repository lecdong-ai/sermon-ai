                ...
                return (
                  <div key={i} className="flex items-center gap-2.5 text-navy-700 hover:text-mint-600 transition-colors cursor-default group">
                    <div className="w-9 h-9 rounded-xl bg-warm-50 flex items-center justify-center group-hover:bg-mint-50 transition-colors">
                      <Icon className="w-5 h-5 text-navy-500 group-hover:text-mint-500 transition-colors" />
                    </div>
            ...
            <Reveal delay={300}>
              <div className="h-full p-7 rounded-2xl bg-gradient-to-br from-navy-900 to-navy-800 text-white flex flex-col justify-center items-center text-center relative overflow-hidden shine-hover">
                ...
                <div className="relative z-10">
                  ...
                  <Link href="/school/pricing" className="inline-flex items-center gap-1.5 text-xs font-bold text-mint-300 hover:text-mint-200 group">
        ...
        <div className="container-custom">
          ...
          <Reveal delay={100}>
            <div className="max-w-md mx-auto bg-white rounded-3xl p-10 shadow-card border border-warm-200 text-center">
              ...
              <Link href="/school/pricing" className="btn-secondary inline-flex items-center gap-2">
