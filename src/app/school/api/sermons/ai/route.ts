...
import { mapBookName } from '@/lib/school/bible/bookMap'
import { SYSTEM_PROMPT as OUTLINE_PROMPT } from '@/lib/school/ai/prompts/outline'
import { SYSTEM_PROMPT as APP_PROMPT, DIRECTION_PROMPT, GENERATE_PROMPT } from '@/lib/school/ai/prompts/application'
import { SYSTEM_PROMPT as CORE_MESSAGE_PROMPT } from '@/lib/school/ai/prompts/core-message'
import { SYSTEM_PROMPT as DELIVERY_PROMPT } from '@/lib/school/ai/prompts/delivery'
import { SYSTEM_PROMPT as MANUSCRIPT_INTRO_PROMPT } from '@/lib/school/ai/prompts/manuscript-introduction'
import { SYSTEM_PROMPT as MANUSCRIPT_CONCLUSION_PROMPT } from '@/lib/school/ai/prompts/manuscript-conclusion'
import { SYSTEM_PROMPT as MANUSCRIPT_APPLICATION_PROMPT } from '@/lib/school/ai/prompts/manuscript-application'
import { SYSTEM_PROMPT as MANUSCRIPT_BODY_PROMPT } from '@/lib/school/ai/prompts/manuscript-body'
import { SYSTEM_PROMPT as MANUSCRIPT_APP_RECONSTRUCT_PROMPT } from '@/lib/school/ai/prompts/manuscript-application-reconstruct'
import { SYSTEM_PROMPT as ILLUSTRATION_PROMPT } from '@/lib/school/ai/prompts/illustration'
import { SYSTEM_PROMPT as REFERENCE_PROMPT } from '@/lib/school/ai/prompts/reference'

import { SYSTEM_PROMPT as MANUSCRIPT_DIAGNOSIS_PROMPT } from '@/lib/school/ai/prompts/manuscript-diagnosis'
import { SYSTEM_PROMPT as REFERENCE_WEAVE_PROMPT } from '@/lib/school/ai/prompts/referenceWeave'
import { SYSTEM_PROMPT as COMMENTARY_TO_SECTION_PROMPT } from '@/lib/school/ai/prompts/commentaryToSection'
...
위 본문(들)에서 설교 준비에 가장 중요한 헬라어/히브리어 원어 4-6개를 추출하여 JSON 객체로 반환하세요. 다중 본문이 제공된 경우 전체 본문을 통틀어 중요 원어를 선정하세요. 키는 "words"입니다.`
    ...
    console.error('POST /api/sermons/ai error:', err)
