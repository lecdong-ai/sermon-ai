  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-50/60">
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute left-[-8%] top-[-12%] h-[520px] w-[520px] rounded-full bg-gradient-to-br from-indigo-300/12 via-blue-300/8 to-transparent blur-3xl" />
        <div className="absolute bottom-[-10%] right-[-6%] h-[540px] w-[540px] rounded-full bg-gradient-to-tr from-purple-300/10 via-indigo-300/6 to-transparent blur-3xl" />
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-start">
          <div className="space-y-6">
            <section className="glass-panel glass-border-neon rounded-[32px] p-6 sm:p-8 lg:p-10">
              ...
              <div className="max-w-2xl">
                <h1 className="text-balance font-outfit text-[clamp(2rem,4vw,3.3rem)] font-extrabold leading-[1.05] text-slate-900">
                  설교 한 편을
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                <div className="rounded-2xl border border-white/70 bg-white/80 p-4 shadow-sm">
                  <div className="mb-2 flex h-10 w-10 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-600">
                    <Sparkles className="h-5 w-5" />
                  </div>
                  <p className="text-[14px] font-bold text-slate-800">AI 추천</p>
                  <p className="mt-1 text-[13px] leading-6 text-slate-500">본문 기반 제목 추천, 제목 기반 본문 추천을 바로 사용할 수 있습니다.</p>
                </div>
                <div className="rounded-2xl border border-white/70 bg-white/80 p-4 shadow-sm">
                  <div className="mb-2 flex h-10 w-10 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-600">
                    <CalendarDays className="h-5 w-5" />
                  </div>
                  <p className="text-[14px] font-bold text-slate-800">주일 기본값</p>
                  <p className="mt-1 text-[13px] leading-6 text-slate-500">다가오는 주일 날짜가 자동으로 채워져 다음 설교 준비에 바로 들어갈 수 있습니다.</p>
                </div>
                <div className="rounded-2xl border border-white/70 bg-white/80 p-4 shadow-sm">
                  ...
                  <p className="mt-1 text-[13px] leading-6 text-slate-500">생성 후 곧바로 본문 관찰, 개요 작성, 원고 정리 단계로 이동합니다.</p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-[28px] border border-indigo-100/80 bg-gradient-to-br from-indigo-50/90 via-white to-blue-50/70 p-6 shadow-sm">
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0">
                  <p className="text-[16px] font-extrabold text-slate-900">입력을 더 잘 시작하는 방법</p>
          ...
          <section className="lg:sticky lg:top-24">
            <div className="glass-panel rounded-[32px] border border-white/80 p-5 shadow-xl shadow-indigo-500/10 sm:p-7">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="mb-2 flex items-center justify-between gap-3">
                    ...
                    {passage.trim() && (
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-full bg-indigo-50 px-3 py-1 text-[12px] font-semibold text-indigo-600 transition-colors hover:bg-indigo-100 disabled:opacity-50"
                      >
                ...
                <div className="rounded-2xl border border-slate-200/70 bg-white/80 p-4 shadow-sm">
                  <label className="mb-2 flex items-center gap-2 text-[14px] font-bold text-slate-900">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-[15px] text-slate-900 focus:border-indigo-300 focus:outline-none focus:ring-4 focus:ring-indigo-100"
                  />
                  <p className="mt-2 text-[12px] text-slate-500">기본값은 다음 주일로 자동 설정됩니다.</p>
                </div>
                ...
                <div className="rounded-2xl border border-indigo-100 bg-gradient-to-r from-indigo-50/90 to-blue-50/90 p-4">
