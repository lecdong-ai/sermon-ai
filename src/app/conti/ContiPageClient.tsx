      ...
      <div className="relative z-10 flex flex-col h-full overflow-y-auto">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-6xl mx-auto px-6 py-6 space-y-6 animate-fade-in">
              ...
              {loadingList ? (
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-[16px] font-bold text-slate-300 mb-1">
                    {searchText ? '검색 결과가 없습니다' : '첫 콘티를 만들어보세요'}
                  </p>
            ...
            {/* 예배유형별 분포 */}
            {worshipCounts.length > 0 && (
              <div>
                <h2 className="text-[15px] font-bold text-white mb-3">예배유형별 콘티</h2>
                        ...
                        <div key={type}>
                          <div className="flex items-center justify-between mb-1">
                            <div className="flex items-center gap-2">
                              <span className={`w-2 h-2 rounded-full ${COLORS[meta.color]}`} />
                              <span className="text-[13px] font-bold text-slate-300">{meta.label}</span>
                            </div>
                            <span className="text-[12px] font-bold text-slate-500">{count}개</span>
                          </div>
