        ...
        <div className="bg-[#0a0e1a] border border-white/10 rounded-2xl p-8 space-y-8">
          ...
          <Section title="제2조 (용어 정의)">
            <ol className="list-decimal list-inside space-y-1.5">
              ...
              <li>"후원회원"이란 회사가 정한 절차에 따라 유료 후원(결제)을 완료하여 후원 회원 자격을 부여받은 이용자를 말합니다.</li>
            </ol>
          </Section>
          ...
          <Section title="제4조 (회원 가입 및 자격)">
            <ol className="list-decimal list-inside space-y-1.5">
              ...
              <li>후원회원 자격은 회사가 정한 후원 절차에 따라 결제가 완료된 시점에 부여되며, 후원 금액에 따라 30일/90일/365일 등 회사가 정한 기간 동안 유효합니다.</li>
            </ol>
          </Section>
          ...
          <Section title="제9조 (후원 및 환불)">
            <ol className="list-decimal list-inside space-y-1.5">
              ...
              <li>후원 회원 자격이 만료된 후에는 추가 요금 없이 <strong>일반 회원</strong>으로 자동 전환되며, 작성한 콘텐츠는 보존됩니다.</li>
