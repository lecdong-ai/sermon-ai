      ...
      <section className="relative overflow-hidden gradient-navy text-white py-20 md:py-32">
        ...
        <div className="relative z-10 container-custom text-center">
          ...
          <p className="text-sm md:text-base text-navy-200 leading-relaxed max-w-lg mx-auto">
            모든 기능은 무료입니다. 파트너 스토어에서의 쇼핑이<br className="hidden sm:block" />
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-navy-500 leading-relaxed">
                    Bunker 목양의 모든 기능을 무료로 제공합니다. 목회 사역에 비용이 걸림돌이 되어서는 안 된다고 믿기 때문입니다.
                  </p>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={200} className="bg-white rounded-3xl p-8 shadow-card border border-warm-200">
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-navy-500 leading-relaxed">
                    파트너 스토어에서 상품을 구매하시면 판매 수익의 일부가 서비스 운영비로 환원됩니다. 특별한 기부나 추가 부담 없이 일상적인 소비가 자연스럽게 사역을 후원하게 됩니다.
                  </p>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={300} className="bg-white rounded-3xl p-8 shadow-card border border-warm-200">
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-navy-500 leading-relaxed">
                    좋은 상품을 합리적인 가격에 구매하고, 그 구매가 다시 서비스로 돌아오는 선순환 구조입니다. 당신의 선택이 더 많은 사역자가 혜택을 누릴 수 있게 합니다.
                  </p>
                </div>
              </div>
            </Reveal>
