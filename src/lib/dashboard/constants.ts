...
export const EMOTION_TAGS = [
  { id: 'emotion-1', name: '도전', category: 'emotion' as const },
  { id: 'emotion-2', name: '격려', category: 'emotion' as const },
  { id: 'emotion-3', name: '경고', category: 'emotion' as const },
  { id: 'emotion-4', name: '기쁨', category: 'emotion' as const },
  { id: 'emotion-5', name: '공감', category: 'emotion' as const },
  { id: 'emotion-6', name: '결단', category: 'emotion' as const },
  { id: 'emotion-7', name: '각성', category: 'emotion' as const },
  { id: 'emotion-8', name: '책망', category: 'emotion' as const },
