...
export const EMOTION_TAGS = [
  ...
  { id: 'emotion-8', name: '감사', category: 'emotion' as const },
  { id: 'emotion-9', name: '기쁨', category: 'emotion' as const },
  { id: 'emotion-10', name: '평안', category: 'emotion' as const },
  { id: 'emotion-11', name: '사랑', category: 'emotion' as const },
  { id: 'emotion-12', name: '은혜', category: 'emotion' as const },
  { id: 'emotion-13', name: '위로', category: 'emotion' as const },
  { id: 'emotion-14', name: '공감', category: 'emotion' as const },
  { id: 'emotion-15', name: '회복', category: 'emotion' as const },
  { id: 'emotion-16', name: '치유', category: 'emotion' as const },
  { id: 'emotion-17', name: '결단', category: 'emotion' as const },
  { id: 'emotion-18', name: '순종', category: 'emotion' as const },
  { id: 'emotion-19', name: '각성', category: 'emotion' as const },
  { id: 'emotion-20', name: '책망', category: 'emotion' as const },
  { id: 'emotion-21', name: '권면', category: 'emotion' as const },
  { id: 'emotion-22', name: '인내', category: 'emotion' as const },
  { id: 'emotion-23', name: '믿음', category: 'emotion' as const },
  { id: 'emotion-24', name: '확신', category: 'emotion' as const },
  { id: 'emotion-25', name: '경외', category: 'emotion' as const },
]
