...
export const QT_TEMPLATES: QtTemplate[] = [
  ...
  },
  {
    ...
    bibleQuoteText: '#3a2a3a',
    prayerBoxBg: '#fff1f2',
    prayerBoxText: '#3a2a3a',
  ...
  },
  {
    ...
    borderLight: '#e7e5e4',
    coverOrnament: '🌿',
    coverAccentLine: '#2d6a4f',
    sectionLabelBorder: '#a7f3d0',
    bibleQuoteBg: '#f5f5f4',
    bibleQuoteBorder: '#2d6a4f',
    bibleQuoteText: '#1c1917',
    prayerBoxBg: '#f0fdf4',
    prayerBoxText: '#1c1917',
    progressDotBg: '#d6d3d1',
    progressDotBorder: '#a8a29e',
    progressDotActiveBg: '#2d6a4f',
    pageNumberColor: '#a8a29e',
    coverTitleSize: '28px',
    coverSubtitleColor: '#2d6a4f',
    bodyLineHeight: '1.7',
    bodySize: '12px',
  },
]
